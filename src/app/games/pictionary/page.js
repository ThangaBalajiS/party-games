...
const BASE_POINTS = 50; // Fixed base points for Pictionary

// Calculate time penalty based on elapsed time
// 0-30s: full score, then -5 for each 20 seconds
const calculateTimePenalty = (elapsedSeconds) => {
    ...
    return Math.min(penaltyIntervals + 1, 5) * 5; // Max penalty is 25
};
...
export default function PictionaryPage() {
    ...
    const calculateScore = useCallback(() => {
        ...
        const total = Math.max(0, BASE_POINTS - penalty);

        return { base: BASE_POINTS, penalty, total, elapsedTime };
    }, [timeRemaining]);
        ...
        return (
            <div className="min-h-screen flex items-center justify-center p-8">
                <div className="text-center">
                    ...
                    <p className="text-gray-400 mb-8">Create teams first to play Pictionary.</p>
                    <Link
                        href="/teams"
        ...
        <div className="min-h-screen p-8" style={{ backgroundColor: '#030712', color: '#f9fafb' }}>
            <div className="max-w-2xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-400 mt-1">Draw it out - faster guesses earn more points!</p>
                </div>
                ...
                <div className="bg-gray-900 rounded-2xl p-6 border border-gray-800">
                    ...
                    {/* Score Display (show when stopped with time remaining) */}
                        ...
                        <div className="border-t border-gray-800 pt-6">
                            ...
                            <div className="flex gap-4">
                                ...
                                <button
                                    ...
                                    className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600
                                        rounded-xl font-bold hover:from-blue-500 hover:to-cyan-500 transition-all"
                                >
                                    ✓ Confirm Score
                                </button>
                            </div>
                ...
                <div className="mt-8 bg-gray-900/50 rounded-xl p-4 border border-gray-800">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <div>🎨 Correct Guess: <span className="text-blue-400 font-bold">50 pts</span></div>
                        </div>
                        <div>
